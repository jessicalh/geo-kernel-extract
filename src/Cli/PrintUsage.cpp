...
void PrintUsage(const char* program_name) {
    (void)std::fprintf(stderr,
        ...
        "      (MOPAC every frame; ~10 min/frame; intractable for fleet runs).\n"
        "\n"
        "Common options:\n"
