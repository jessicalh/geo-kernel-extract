...
void TripeptideBackboneShieldingTimeSeriesTrajectoryResult::Compute(
...
void TripeptideBackboneShieldingTimeSeriesTrajectoryResult::Finalize(
    ...
    OperationLog::Info(LogCalcOther,
        "TripeptideBackboneShieldingTimeSeriesTrajectoryResult::Finalize",
...
void TripeptideBackboneShieldingTimeSeriesTrajectoryResult::WriteH5Group(
    ...
    if (source_present_count == 0) {
        OperationLog::Warn(
            ...
            " frames; skipping /trajectory/tripeptide_bb_shielding_time_series/ "
