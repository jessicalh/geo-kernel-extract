...
public:
    ...
    // Per-frame dependency: TripeptideNeighborShieldingResult must
    // run so that ConformationAtom::tripeptide_neighbor_shielding_spherical
    // is populated before this result reads it.
