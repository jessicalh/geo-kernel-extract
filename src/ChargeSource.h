...
//   PrmtopChargeSource         — AMBER prmtop direct text parser
...
enum class ChargeModelKind {
    ...
    GromacsTpr,             // GROMACS TPR stored charges (placeholder PB radii)
...
// Compatibility quarantine for current GROMACS TPR plumbing. The TPR path
// provides real charges but not a defensible APBS/PB radius set yet.
// TODO(charge-model): replace this with PB radii from a defensible source
// before treating APBS outputs from that path as standard.
...
// ============================================================================
// ff14SB from flat parameter file
// ============================================================================
