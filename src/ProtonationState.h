...
//
// The residue-level decision is load-bearing, not metadata:
...
//   - Feeds topology preparation once projected onto Residue state
//
// A ProtonationState is a VALUE TYPE for holding decisions from a
// protonation tool (PROPKA, KaML, tleap default) or manual assignment.
//
...
public:
    ...
    // Non-titratable residues contribute their charged_formal_charge.
