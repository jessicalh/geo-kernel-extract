...
// invisible. We key by atom_idx structurally, warn and skip geometry
// atoms without a matching tensor row, and fail loud on duplicate
// atom_idx values or element mismatches.
//
