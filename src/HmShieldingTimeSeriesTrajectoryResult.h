...
//
// Parity matches BS: HM is a shielding tensor, and the antisymmetric
// T1 channel is an axial/even pseudovector (1e). Units differ from BS:
// HM stores -n⊗V where V is the surface integral in Å⁻¹ (no
