...
Changing \(\phi,\psi\) changes which groups lie above and below that plane, but
hydrogen bonding to the carbonyl oxygen can also move the carbonyl tensor.
...
acid types and protein comparisons \cite{oldfield1995,havlin2001}. Solution and
...
Backbone amide protons are the cleanest hydrogen-bond category. An amide
...
Tyr, Trp, or His ring can shield or deshield \(H^\mathrm N\), and benchmark
work has measured the magnitude of ring-current effects on amide-proton shifts
\cite{christensen2011}. APBSField and WaterField supply field and
...
this channel: enhanced sampling improved chemical-shift prediction most strongly
for \(^{15}\mathrm N\) in Markwick and co-workers' study of heterogeneous
protein dynamics \cite{markwick2010}. CSA measurements and quantum studies also
...
\cite{sahakyan2011}. PPM uses ring-current, magnetic-anisotropy,
electric-field, hydrogen-bond, dihedral, and sequence descriptors in an
ensemble setting \cite{li2012}. UCBShift 2.0 extends this categorical view to
side-chain atom types and finds ring currents and hydrogen bonding important
for many side-chain hydrogens and nitrogens \cite{ptaszek2024}. These are
...
side-chain \(C=O\), aromatic, disulfide, and other side-chain bond categories.
...
SHIFTX 2003, SHIFTX2 2011, CamShift 2009, ProCS15 2015, Havlin 2001, Yao
...
\bibitem{havlin2001}
Havlin, R. H., Laws, D. D., Bitter, H.-M. L., Sanders, L. K., Sun, H.,
Grimley, J. S., Wemmer, D. E., Pines, A., and Oldfield, E. (2001).
Carbon-13 NMR shielding in the twenty common amino acids: comparisons with
experimental results in proteins.
\emph{Journal of the American Chemical Society}, 123, 10362--10369.
