...
Status: **DESIGNED, not built**. This document specifies the Stage-3
...
Two companion specs named by the brief were not present anywhere under
`/shared/2026Thesis/nmr-shielding/h5-reader` at authoring time:
`SPEC_720_STATIC_INGEST_2026-06-04.md` and
`SPEC_INTERP_1P9J_SCOPING_2026-06-04.md`. Their briefs exist, so this document
cross-references those spec names as planned dependencies and marks their
contents **OPEN / not locally grounded**.
...
- The companion 720 ingest and 1P9J interpolation specs are not locally present.
...
- **720-WT static ingest.** Needed for transferability and the between-axis
  ...
  `SPEC_720_STATIC_INGEST_2026-06-04.md` (**OPEN: file not present locally**).
- **1P9J interpolation spec.** The v0/down-payment should align with this
  architecture. Cross-reference target:
  `SPEC_INTERP_1P9J_SCOPING_2026-06-04.md` (**OPEN: file not present locally**).
