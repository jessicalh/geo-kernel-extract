...
std::vector<RowColumnSpec> buildSchema() {
    std::vector<RowColumnSpec> s = {
        ...
        col("prev_chi1_region", RowColType::Int, "", "", RowNativeAxis::Residue, true),
        col("prev_chi1_present", RowColType::Bool, "", "", RowNativeAxis::Residue, true),
        col("prev_chi1_missing_reason", RowColType::String, "", "", RowNativeAxis::Residue, true),
