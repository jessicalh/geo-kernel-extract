...
TIER_ORDER = ["classical_mechanisms_combined", "plus_AIMNet2", "all"]
TIER_LABELS = {
...
TIER_PREVIOUS = {
    ...
    "plus_AIMNet2": "classical_mechanisms_combined",
    "all": "plus_AIMNet2",
}
...
TIER_BLOCKS = {
    "classical_mechanisms_combined": [x[0] for x in CLASSICAL_BLOCK_SPECS],
    "plus_AIMNet2": [x[0] for x in CLASSICAL_BLOCK_SPECS + AIMNET_BLOCK_SPECS],
    "all": [x[0] for x in CLASSICAL_BLOCK_SPECS + AIMNET_BLOCK_SPECS + RAW_CHARGE_BLOCK_SPECS],
}
