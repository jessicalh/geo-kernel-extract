...
void addDenseH5(QVector<SignalDescriptor>& descriptors) {
    ...
    add(descriptors, makeDescriptor("h5:water_efield_clamp_mask_time_series", "water_efield_clamp_mask", SignalSourceKind::DenseH5Trajectory, "TrajectoryH5", "water_field", "Water E-field clamp mask", SourceResidency::StartupLoaded, SignalAxis::Atom, SignalAxis::Atom, SignalValueShape::Category, tag, categoryStripModes(), categoryStaticModes(), {channel("clamp", "Clamp", SignalValueShape::Category, tag)}, "/trajectory/water_field_time_series", true));
    add(descriptors, makeDescriptor("h5:water_efield_clamp_scale_time_series", "water_efield_clamp_scale", SignalSourceKind::DenseH5Trajectory, "TrajectoryH5", "water_field", "Water E-field clamp scale", SourceResidency::StartupLoaded, SignalAxis::Atom, SignalAxis::Atom, SignalValueShape::Scalar, none, scalarStripModes(), scalarStaticModes(), scalarChannels(none), "/trajectory/water_field_time_series", true));
    add(descriptors, makeDescriptor("h5:water_efield_first_clamp_mask_time_series", "water_efield_first_clamp_mask", SignalSourceKind::DenseH5Trajectory, "TrajectoryH5", "water_field", "First-shell water E-field clamp mask", SourceResidency::StartupLoaded, SignalAxis::Atom, SignalAxis::Atom, SignalValueShape::Category, tag, categoryStripModes(), categoryStaticModes(), {channel("clamp", "Clamp", SignalValueShape::Category, tag)}, "/trajectory/water_field_time_series", true));
    add(descriptors, makeDescriptor("h5:water_efield_first_clamp_scale_time_series", "water_efield_first_clamp_scale", SignalSourceKind::DenseH5Trajectory, "TrajectoryH5", "water_field", "First-shell water E-field clamp scale", SourceResidency::StartupLoaded, SignalAxis::Atom, SignalAxis::Atom, SignalValueShape::Scalar, none, scalarStripModes(), scalarStaticModes(), scalarChannels(none), "/trajectory/water_field_time_series", true));
...
void addFrameNpy(QVector<SignalDescriptor>& descriptors) {
    ...
    npy("pyramidalization", "pyramidalization", "planar_geometry", "Pyramidalization magnitude", SignalAxis::Atom, SignalValueShape::Scalar, length, scalarStripModes(), {}, scalarChannels(length));
    npy("pyramidalization_valid", "pyramidalization_valid", "planar_geometry", "Pyramidalization valid mask", SignalAxis::Atom, SignalValueShape::Category, tag, categoryStripModes(), categoryStaticModes(), {channel("valid", "Valid", SignalValueShape::Category, tag)});
    npy("pyramidalization_center_type", "pyramidalization_center_type", "planar_geometry", "Pyramidalization center type", SignalAxis::Atom, SignalValueShape::Category, tag, categoryStripModes(), categoryStaticModes(), {channel("center_type", "Center type", SignalValueShape::Category, tag)});
